...
import Abstraction from "./media/Abstraction.svg";
...
const FormValidation = () => {
  ...
  return (
    <div className="cont">
      <p className="content" style={{position:"absolute", top:"15%",left:"5%", fontSize:"24px", fontWeight:"bold", color:"white"}}>Find 3D Objects, Mockups 
      <br></br>and Ilustration here</p>
